...
const spriteTorch = new Sprite({
    ...
    imageSrc: './game-assets/imgs/firePlace.png',
    scale: 2,
    framesMax: 6
})
...
function animate() {
    ...
    if(rectangularCollision({ 
        ...
        enemy.health -= 20;
        document.querySelector('.enemyCurrentLife').style.width = `${enemy.health}%`;
    ...
    if(rectangularCollision({ 
        ...
        player.health -= 20;
        document.querySelector('.playerCurrentLife').style.width = `${player.health}%`;
